 ...
 * 
 * @param i the id of the pawn.
 * @param p the file path of the image of the pawn.
...
/**
 * Overrides the move method from the Piece abstract class to provide specific movement behavior for the pawn.
 * 
 * @param state the current state of the chessboard.
 * @param x the current x-coordinate of the pawn.
 * @param y the current y-coordinate of the pawn.
